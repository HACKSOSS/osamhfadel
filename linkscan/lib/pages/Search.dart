...
import 'package:linkscan/pages/settings_page.dart';
import 'logs.dart';
  ...
  Future<void> scanUrl(String url) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Get the scan result
        await Future.delayed(const Duration(seconds: 5)); // Wait for scanning
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('بحث الروابط الضارة'),
        actions: const [
          // IconButton(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'ابحث عن اي رابط والتحقق من وجود رابط ضار:',
                ...
                onPressed: _isLoading
                    ...
                    : () {
                        ...
                        if (url.isNotEmpty) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('الرجاء ادخال الرابط '),
                            ),
                          );
                        }
                      },
            ...
            if (_scanResult != null)
              Expanded(
                child: SingleChildScrollView(
                  child: _scanResult!.containsKey('خطا')
                      ? Center(
                          child: Text(
                            _scanResult!['خطا'],
                            style: const TextStyle(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                buildResultRow('ضار', Colors.red,
                                    _scanResult!['malicious']),
                                buildResultRow('مشتبة به', Colors.orange,
